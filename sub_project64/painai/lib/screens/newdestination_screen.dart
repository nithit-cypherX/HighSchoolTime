...
import 'package:painai/models/newdestination_model.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:painai/screens/selectplace_screenc_new.dart';
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: CachedNetworkImageProvider(newdestinations[index].image)),
                          ),
                          child: Stack(
                            children: <Widget>[
                              Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(padding: EdgeInsets.only(left: 5.0,right: 5)),
                                        Text(newdestinations[index].name,
